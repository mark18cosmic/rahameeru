...
const Hero = () => {
    return (
        <section className="bg-white">
            <div className="flex flex-col lg:flex-row justify-center items-center max-w-screen-xl px-4 py-8 m-4 md:m-6 lg:gap-8 xl:gap-0 lg:py-16">
                {/* Left side: Heading and Buttons */}
                <div className="md:w-full lg:w-1/2 place-self-center text-center lg:text-left">
